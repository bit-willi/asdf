import{_ as s,o as a,c as n,V as l}from"./chunks/framework.5a3bb230.js";const m=JSON.parse('{"title":"All Commands","description":"","frontmatter":{},"headers":[],"relativePath":"manage/commands.md","filePath":"manage/commands.md","lastUpdated":1687069487000}'),e={name:"manage/commands.md"},t=l(`<h1 id="all-commands" tabindex="-1">All Commands <a class="header-anchor" href="#all-commands" aria-label="Permalink to &quot;All Commands&quot;">​</a></h1><p>The list of all commands available in <code>asdf</code>. This list is the <code>asdf help</code> command text.</p><div class="language-txt"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">MANAGE PLUGINS</span></span>
...
<span class="line"><span style="color:#A6ACCD;">Docs:   https://asdf-vm.com</span></span></code></pre></div>`,3),p=[t];function o(i,c,r,A,C,d){return a(),n("div",null,p)}const f=s(e,[["render",o]]);export{m as __pageData,f as default};
